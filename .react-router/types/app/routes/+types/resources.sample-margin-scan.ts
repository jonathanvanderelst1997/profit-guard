...
type Module = typeof import("../resources.sample-margin-scan.js")

type Info = GetInfo<{
  file: "routes/resources.sample-margin-scan.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../resources.sample-margin-scan.js");
}];
