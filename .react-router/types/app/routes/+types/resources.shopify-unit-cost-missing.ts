...
type Module = typeof import("../resources.shopify-unit-cost-missing.js")

type Info = GetInfo<{
  file: "routes/resources.shopify-unit-cost-missing.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../resources.shopify-unit-cost-missing.js");
}];
