...
export const PLAN_LIMITS: Record<PlanKey, { label: string; variantLimit: number; monthlyPrice: number; features: string[] }> = {
  free: {
    ...
    variantLimit: 100,
    monthlyPrice: 0,
    features: ["Scan up to 100 variants", "Demo mode", "Basic findings table"],
  },
  starter: {
    label: "Starter",
    variantLimit: 5000,
    monthlyPrice: 19,
    features: ["Scan up to 5,000 variants", "CSV import", "CSV export", "Weekly alerts"],
  },
  growth: {
    label: "Growth",
    variantLimit: 25000,
    monthlyPrice: 49,
    features: ["Scan up to 25,000 variants", "CSV import", "CSV export", "Weekly alerts", "Priority support"],
  },
};
