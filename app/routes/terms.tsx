...
export default function TermsOfService() {
  return (
    <PublicInfoPage title="Terms of Service" eyebrow="Last updated: June 13, 2026">
      ...
      <p>Merchants are responsible for reviewing all findings before taking action. Profit Guard provides gross product margin calculations based on available product cost and price data. It is not accounting, tax, legal, or financial advice.</p>
